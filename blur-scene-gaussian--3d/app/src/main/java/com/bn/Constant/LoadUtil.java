...
public class LoadUtil
{
	...
	public static LoadedObjectVertexNormalTextureMian loadFromFileMian(String fname, Resources r,MySurfaceView mv)
	{//从obj文件中加载仅携带顶点信息的物体，并计算面法向量

		LoadedObjectVertexNormalTextureMian lo=null; //加载后物体的引用
		...
		try
		{
			...
			lo=new LoadedObjectVertexNormalTextureMian(mv,vXYZ,nXYZ,tST);
		}
		catch(Exception e)
		{
			Log.d("load error", "load error");
