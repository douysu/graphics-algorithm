...
public class WomanBodySingle implements Comparable<WomanBodySingle>{
    float centerX;//中心X坐标
    float centerY;//中心Y坐标
    float centerZ;//中心Z坐标
    ...
    String objNanem="";
    MySurfaceView mv;
    public WomanBodySingle(String objName, MySurfaceView mv, int programId, float centerX, float centerY, float centerZ)
    {
    ...
    @Override
    public int compareTo(WomanBodySingle another) {
